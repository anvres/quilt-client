package tech.quilt.utility.render.display.shader;
...
import tech.quilt.utility.interfaces.IWindow;
import tech.quilt.utility.math.MathUtil;
import tech.quilt.utility.render.display.Render2DUtil;
import tech.quilt.utility.render.display.base.BorderRadius;
import tech.quilt.utility.render.display.base.CustomSprite;
import tech.quilt.utility.render.display.base.Gradient;
...
public final class DrawUtil implements IWindow {
   ...
   public static void initializeShaders() {
      rectangleProgram = new GlProgram(Quilt.id("rectangle/data"), VertexFormats.POSITION_COLOR);
      squircleProgram = new GlProgram(Quilt.id("squircle/data"), VertexFormats.POSITION_COLOR);
      squircleTextureProgram = new GlProgram(Quilt.id("squircle_texture/data"), VertexFormats.POSITION_TEXTURE_COLOR);
      roundedTextureProgram = new GlProgram(Quilt.id("texture/data"), VertexFormats.POSITION_TEXTURE_COLOR);
      borderProgram = new GlProgram(Quilt.id("border/data"), VertexFormats.POSITION_COLOR);
      figmaBorderProgram = new GlProgram(Quilt.id("corner/data"), VertexFormats.POSITION_COLOR);
      loadingProgram = new GlProgram(Quilt.id("loading/data"), VertexFormats.POSITION_COLOR);
      gradientRectangleProgram = new GlProgram(Quilt.id("gradient_rectangle/data"), VertexFormats.POSITION_COLOR);
      blurProgram = new GlProgram(Quilt.id("blur/data"), VertexFormats.POSITION_COLOR);
      metaballsProgram = new GlProgram(Quilt.id("metanoise/data"), VertexFormats.POSITION_COLOR);
   }
   ...
   public static void drawGlow(MatrixStack matrixStack, float x, float y, float width, float height, int glowRadius) {
      Render2DUtil.drawGradientBlurredShadow(matrixStack, x, y, width, height, glowRadius, Gradient.of(Quilt.getInstance().getThemeManager().getCurrentTheme().getColor(), Quilt.getInstance().getThemeManager().getCurrentTheme().getColor(), Quilt.getInstance().getThemeManager().getCurrentTheme().getSecondColor(), Quilt.getInstance().getThemeManager().getCurrentTheme().getSecondColor()));
   }
