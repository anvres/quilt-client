package tech.quilt.base.waypoint;
   ...
   public void onHUD(EventHudRender e) {
      if (mc.player != null) {
         ...
         if (this.activeWaypoint != null) {
            ...
            e.getContext().getMatrices().translate(-x, -y, 0.0F);
            e.getContext().drawTexture(Quilt.id("icons/arrow.png"), x - size / 2.0F, y - size / 2.0F, size, size, Quilt.getInstance().getThemeManager().getCurrentTheme().getColor());
         ...
         if (this.activePlayerWaypoint != null) {
            ...
            e.getContext().getMatrices().multiply(RotationAxis.POSITIVE_Z.rotationDegrees(yaw));
            e.getContext().getMatrices().translate(-x, -y, 0.0F);
            e.getContext().drawTexture(Quilt.id("icons/arrow.png"), x - size / 2.0F, y - size / 2.0F, size, size, new ColorRGBA(255, 32, 32));
            e.getContext().getMatrices().pop();
         }
