package tech.quilt.client.screens.menu;
...
import tech.quilt.client.screens.menu.wonderful.ClickGuiInputHandler;
import tech.quilt.client.screens.menu.wonderful.ClickGuiLayout;
import tech.quilt.client.screens.menu.wonderful.ClickGuiRenderer;
import tech.quilt.client.screens.menu.wonderful.ClickGuiSettingRenderer;
import tech.quilt.client.screens.menu.wonderful.ClickGuiState;
...
public class MenuScreen extends Screen implements IClient {
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        ...
        return inputHandler.mouseClicked(mouseX, mouseY, button, IMinecraft.mc.getWindow())
