...
public class UniversalRotation extends RotationBase {
    ...
    public void update(LivingEntity target, Rotation targetAngle, boolean elytraVisual) {
        ...
        float baseYawSpeed = (12.0F + rng.nextFloat() * 10.0F) * speedMultiplier / (isElytra ? 2.2F : 1.0F);
        float basePitchSpeed = (6.0F + rng.nextFloat() * 6.0F) * speedMultiplier / (isElytra ? 2.2F : 1.0F);
