...
import tech.quilt.base.events.impl.input.EventSetScreen;
...
import tech.quilt.client.hud.elements.component.TargetHudComponent;
import tech.quilt.client.hud.elements.component.WatermarkComponent;
...
import tech.quilt.utility.render.display.base.GuiUtil;
...
public final class Interface extends Module {
   ...
   private Interface() {
      ...
      Quilt.getInstance().getNotifyManager().setNotifyComponent(notifyComponent);
